...
public class Davinchicode extends JFrame{
	...
	/*public Davinchicode(LoginUser loginuser) {
	...
	private void play() {
		...
		textArea.append("숫자를 입력하고 \n");
		textArea.append("맞추고싶은 카드를 선택해 주세요 \n");
	...
	private void cardchoice() {
		...
		//if user = 1 일때
		if(user1cardBtn1.getText().equals(user1cardBtn2.getText())) {
			Color col = user1cardBtn1.getBackground();
			Color col2 = user1cardBtn1.getForeground();
			user1cardBtn1.setBackground(user1cardBtn2.getBackground());
			user1cardBtn1.setForeground(user1cardBtn2.getForeground());
			user1cardBtn2.setBackground(col);
			user1cardBtn2.setForeground(col2);
			
		}
		if(user1cardBtn2.getText().equals(user1cardBtn3.getText())) {
			Color col = user1cardBtn2.getBackground();
			Color col2 = user1cardBtn2.getForeground();
			user1cardBtn2.setBackground(user1cardBtn3.getBackground());
			user1cardBtn2.setForeground(user1cardBtn3.getForeground());
			user1cardBtn3.setBackground(col);
			user1cardBtn3.setForeground(col2);
		}
		if(user1cardBtn3.getText().equals(user1cardBtn4.getText())) {
			Color col = user1cardBtn3.getBackground();
			Color col2 = user1cardBtn3.getForeground();
			user1cardBtn3.setBackground(user1cardBtn4.getBackground());
			user1cardBtn3.setForeground(user1cardBtn4.getForeground());
			user1cardBtn4.setBackground(col);
			user1cardBtn4.setForeground(col2);
		}
		if(user1cardBtn1.getText().equals(user1cardBtn4.getText())) {
			Color col = user1cardBtn1.getBackground();
			Color col2 = user1cardBtn1.getForeground();
			user1cardBtn1.setBackground(user1cardBtn4.getBackground());
			user1cardBtn1.setForeground(user1cardBtn4.getForeground());
			user1cardBtn4.setBackground(col);
			user1cardBtn4.setForeground(col2);
		}
		
		//if user = 2 일때
		if(user2cardBtn1.getText().equals(user2cardBtn2.getText())) {
			Color col = user2cardBtn1.getBackground();
			Color col2 = user2cardBtn1.getForeground();
			user2cardBtn1.setBackground(user2cardBtn2.getBackground());
			user2cardBtn1.setForeground(user2cardBtn2.getForeground());
			user2cardBtn2.setBackground(col);
			user2cardBtn2.setForeground(col2);
		}
		if(user2cardBtn2.getText().equals(user2cardBtn3.getText())) {
			Color col = user2cardBtn2.getBackground();
			Color col2 = user2cardBtn2.getForeground();
			user2cardBtn2.setBackground(user2cardBtn3.getBackground());
			user2cardBtn2.setForeground(user2cardBtn3.getForeground());
			user2cardBtn3.setBackground(col);
			user2cardBtn3.setForeground(col2);
		}
		if(user2cardBtn3.getText().equals(user2cardBtn4.getText())) {
			Color col = user1cardBtn3.getBackground();
			Color col2 = user1cardBtn3.getForeground();
			user2cardBtn3.setBackground(user2cardBtn4.getBackground());
			user2cardBtn3.setForeground(user2cardBtn4.getForeground());
			user2cardBtn4.setBackground(col);
			user2cardBtn4.setForeground(col2);
		}
		if(user2cardBtn1.getText().equals(user2cardBtn4.getText())) {
			Color col = user2cardBtn1.getBackground();
			Color col2 = user2cardBtn1.getForeground();
			user2cardBtn1.setBackground(user2cardBtn4.getBackground());
			user2cardBtn1.setForeground(user2cardBtn4.getForeground());
			user2cardBtn4.setBackground(col);
			user2cardBtn4.setForeground(col2);
		}
